        ...
        <div class="section-60">
            <div class="shell">
                <div class="range range-50 range-lg-justify range-xs-center">
                    <div class="cell-md-3 cell-lg-3"><a class="reveal-inline-block" href="index.html"><img src="images/logo-bottom.png" alt="" srcset="images/logo-bottom.png"></a>
                            ...
                            <ul class="list-unstyled contact-info list">
                                <li>
                                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                                        ...
                                        <div class="unit-body"><a class="text-dark" href="tel:#">09855069544,</a><a class="reveal-block reveal-md-inline-block text-dark" href="tel:#">09056013020</a></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                                        <div class="unit-left"><span class="icon novi-icon mdi mdi-map-marker text-middle icon-xs text-madison"></span></div>
                                        <div class="unit-body text-left"><a class="text-dark" href="#">PM Sobrecary Street Poblacion Caraga, Caraga, Philippines</a></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                                        <div class="unit-left"><span class="icon novi-icon mdi mdi-email-open text-middle icon-xs text-madison"></span></div>
                                        <div class="unit-body"><a href="mailto:#">cticaraga2020@gmail.com</a></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
